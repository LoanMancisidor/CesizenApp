            ...
            <tbody>
                @foreach ($users as $user)
                    <tr>
                        ...
                        <td>
                            <span
                                class="role-badge {{ $user->role && $user->role->libelle === 'Administrateur' ? 'role-admin' : 'role-user' }}">
                        ...
                        <td
                            style="text-align: right; display: flex; justify-content: flex-end; align-items: center; gap: 10px;">
                            ...
                            <a href="{{ route('users.edit', $user->id) }}" class="btn-edit"
                                style="text-decoration: none; font-size: 0.85rem; color: var(--medium-green); font-weight: 600;">Modifier</a>
                            ...
                            @else
                                <span
                                    style="font-size: 0.75rem; color: #a0aec0; font-style: italic; width: 80px; text-align: center;">(Votre
                                    compte)</span>
                            @endif
                        </td>
                    </tr>
