<div id="custom-modal" class="modal-overlay">
    <div class="modal-card">
        ...
        <div id="modal-warning-zone" style="display: none; margin-top: 15px; padding: 10px; background: #fff5f5; border-radius: var(--radius-md); border: 1px solid var(--red);">
        ...
        <div id="modal-user-warning" style="display: none; margin-top: 15px; padding: 12px; background: #fff5f5; border-radius: var(--radius-md); border: 1px solid var(--red);">
            <p style="color: var(--red); font-weight: bold; font-size: 0.85rem; margin: 0;">⚠️ Attention !</p>
            <p style="font-size: 0.8rem; margin: 5px 0;">Les membres suivants seront reclassés en <strong>Utilisateur</strong> :</p>
